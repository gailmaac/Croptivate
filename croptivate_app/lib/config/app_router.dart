...
import 'package:croptivate_app/screens/authentication/login/setup_buyer.dart';
import 'package:croptivate_app/screens/authentication/login/setup_seller.dart';
...
class AppRouter {
  static Route onGenerateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case SetUpSeller.routeName:
        return SetUpSeller.route();
