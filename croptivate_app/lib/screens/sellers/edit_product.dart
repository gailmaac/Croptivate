...
class _EditProductState extends State<EditProduct> {
  ...
  bool imageOneChanged = false;
  bool imageTwoChanged = false;
  bool imageThreeChanged = false;
  ...
  uploadImageOne(imageOne) async {
    UploadTask uploadTaskOne = storageRef
        .child("sellerposts_$postId/post_$postIdOne.jpg")
        .putFile(imageOne);
  ...
  uploadImageTwo(imageTwo) async {
    UploadTask uploadTaskTwo = storageRef
        .child("sellerposts_$postId/post_$postIdTwo.jpg")
        .putFile(imageTwo);
  ...
  uploadImageThree(imageThree) async {
    UploadTask uploadTaskThree = storageRef
        .child("sellerposts_$postId/post_$postIdThree.jpg")
        .putFile(imageThree);
  ...
  Future updatePostInFirestore({
    ...
    return await postRef.doc(widget.product.sellerPostId).update({
      // "postId": postId,
  ...
  handleUpdate() async {
    ...
    String imageUrlOne;
    if (imageOneChanged == true) {
      imageUrlOne = await uploadImageOne(imageOne);
    } else {
      imageUrlOne = widget.product.imageUrlOne;
    }

    String imageUrlTwo;
    if (imageTwoChanged == true) {
      imageUrlTwo = await uploadImageTwo(imageTwo);
    } else {
      imageUrlTwo = widget.product.imageUrlTwo;
    }

    String imageUrlThree;
    if (imageThreeChanged == true) {
      imageUrlThree = await uploadImageThree(imageThree);
    } else {
      imageUrlThree = widget.product.imageUrlThree;
    }
                  ...
                  child: Container(
                    ...
                    child: DropdownButton(
                        hint: Text("Choose Product Category",
                            style:
                                inputBodyText.copyWith(color: Colors.black87)),
                  ...
                  child: Stack(
                    children: [
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          validator: (val) =>
                              val!.isEmpty ? 'Please Input Product Name' : null,
                          ...
                          decoration: InputDecoration(
                            ...
                            border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(6),
                                borderSide:
                                    BorderSide(color: cGrey, width: 1.0)),
                  ...
                  child: Stack(
                    children: [
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          validator: (val) =>
                              val!.isEmpty ? 'Please Input Stock Number' : null,
                  ...
                  child: Stack(
                    children: [
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          validator: (val) =>
                              val!.isEmpty ? 'Please Input Price' : null,
